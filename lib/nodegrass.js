...
//@Param url
//@Param callback
NodeGlass.prototype.get = function(url,callback,charset){
...
//@Param header
//@param postdata
NodeGlass.prototype.post = function(url,callback,reqheaders,data,charset){
	var protocol = getProtocol(url);
	 var _defaultCharSet = 'utf8';
	 var content = "";
	 if(typeof charset === 'string' ){
...
var nodeglass = new NodeGlass();
nodeglass.NodeGlass = NodeGlass;
module.exports = nodeglass;
